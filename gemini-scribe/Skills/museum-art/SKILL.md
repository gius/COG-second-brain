---
name: museum-art
description: "Source authentic, high-resolution public-domain artwork from museum open-access APIs (Met, Cleveland, SMK, Rijksmuseum, NGA, Art Institute of Chicago, Getty, Smithsonian) instead of AI-generated or generic stock imagery. Reach for it whenever a visual needs a credible, aesthetic image: blog heroes, decks, social cards, essay and spec figures. Keyless recipes and licensing rules inside."
metadata:
  roles: all
  integrations: web-fetch
  keywords: museum art,public domain image,hero image,find artwork,open access art,stock photo alternative,blog header image,deck imagery
  display-name: COG Museum Art
---
