...
- [`references/profile-templates.md`](references/profile-templates.md) - the four documents step 6 creates: `MY-PROFILE`, `MY-INTERESTS`, `COMPETITIVE-WATCHLIST`, `PROJECT-OVERVIEW`.
- [`references/welcome-guide.md`](references/welcome-guide.md) - the `WELCOME-TO-COG.md` template step 8 generates.
