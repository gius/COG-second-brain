...
> Works with [Claude Code](https://claude.ai/download) &bull; [Antigravity CLI](https://github.com/google-gemini/antigravity) &bull; [OpenAI Codex](https://github.com/openai/codex) &bull; any AI that reads markdown
...
Built with [Claude Code](https://claude.ai/code), [Antigravity CLI](https://github.com/google-gemini/antigravity), [OpenAI Codex](https://github.com/openai/codex), and [Obsidian](https://obsidian.md/). Inspired by Zettelkasten, Building a Second Brain, and GTD.
